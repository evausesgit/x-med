// Contenu FRANÇAIS de la page « Comment ça marche ». Texte d'origine du
// produit, inchangé — seule la version anglaise (content.en.tsx) est nouvelle.
// Server Component : aucun état, aucune interactivité.
import Link from "next/link";
import Step from "./Step";

export default function ArchitectureFr() {
  return (
    <>
