...
2. **La PR #73 ne change rien sur ce cas.** Le bras B rend la même moyenne que A (0,7)
   et la même distribution aux deux articles pont. Elle consomme en revanche
   **335 984 tokens contre 102 326** — **3,3×** — pour un résultat identique. Cela
   confirme par la mesure l'observation « même avec le rollback, pas de résultats ».
